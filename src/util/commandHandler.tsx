...
export const getCommandOutput = (cmd: string): ReactNode => {
  ...
  if (trimmed === "help") {
    return (
      <div className="text-[#888]">
        Available commands:
        <br />  <span className="text-[#00ff41]">help</span>              - Show this help message
        <br />  <span className="text-[#00ff41]">clear</span>             - Clear terminal history
        <br />  <span className="text-[#00ff41]">whoami</span>            - Display current user
        <br />  <span className="text-[#00ff41]">pwd</span>               - Print working directory
        <br />  <span className="text-[#00ff41]">ls</span>                - List directory contents
        <br />  <span className="text-[#00ff41]">cat</span> [file]        - Display file contents
        <br />  <span className="text-[#00ff41]">echo</span> [text]       - Print text
        <br />  <span className="text-[#00ff41]">date</span>              - Show current date/time
        <br />  <span className="text-[#00ff41]">uname</span>             - System information
        <br />  <span className="text-[#00ff41]">history</span>           - Show command history
        <br />  <span className="text-[#00ff41]">neofetch</span>          - Display system info
        <br />  <span className="text-[#00ff41]">about</span>             - About me
        <br />  <span className="text-[#00ff41]">skills</span>            - List my skills
        <br />  <span className="text-[#00ff41]">projects</span>          - List my projects
        <br />  <span className="text-[#00ff41]">contact</span> / <span className="text-[#00ff41]">connect</span> - Contact links
      </div>
    );
  }
  ...
  if (trimmed === "neofetch" || trimmed === "neofetch --ascii") {
    return (
      <div>
        <pre className="ascii-art text-center my-4 terminal-glow">{LIOR_ASCII}</pre>
  ...
  if (
    ...
    return (
      <div className="text-[#888] mt-1">
        <div>
          <span className="text-[#00ff41]">blog</span> - Tech & AI thoughts - deep dives into
          software engineering
        </div>
        <div>
          <span className="text-[#00ff41]">milan</span> - Hebrew word game - daily puzzle challenge
        </div>
        <div>
          <span className="text-[#00ff41]">hzi</span> - Smart electricity calculator - optimize your
          energy usage
        </div>
        <div>
          <span className="text-[#00ff41]">fireplace</span> - Retirement location finder - discover
          your ideal destination
        </div>
        <div>
          <span className="text-[#00ff41]">cmprsr</span> - Learn compression algorithms - interactive
          visualizations
        </div>
      </div>
    );
  ...
  if (baseCmd === "cat") {
    ...
    return <span className="text-[#ff3333]">cat: {file}: No such file or directory</span>;
  }
  ...
  if (trimmed === "uname" || trimmed === "uname -a") {
    return <span className="text-[#888]">Human v2.0 lior-dev 20+ years experience</span>;
  }
  ...
  return <span className="text-[#ff3333]">zsh: command not found: {baseCmd}</span>;
};
